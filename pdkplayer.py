# -*- coding: utf-8 -*-
''' Implement Paodekuai Player class
'''
...
#        state['landlord'] = public['landlord']
    ...
    def available_actions(self, greater_player=None, judger=None):
        ...
        Args:
            greater_player (PaodekuaiPlayer object): player who played
        current biggest cards.
            judger (PaodekuaiJudger object): object of PaodekuaiJudger
        ...
        if greater_player is None or greater_player.player_id == self.player_id:
            actions = judger.get_playable_cards(self)  # get all cards without comparison
        else:
            actions = get_gt_cards(self, greater_player)  # only the larger cards can work!
        return actions
    ...
    def play(self, action, greater_player=None):
        ...
        Returns:
            object of PaodekuaiPlayer: If there is a new greater_player, return it, if not, return None
        '''
    ...
    def play_back(self):
        ...
        self._current_hand.sort(key=functools.cmp_to_key(paodekuai_sort_card))
